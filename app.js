...
const initialBooks = [
  ...
  },
  {
    ...
    genre: 'Finance',
    ISBN: '726919121',
    thumbnail: 'https://m.media-amazon.com/images/I/51JkDEpHUQL.jpg',
    availability: true,
  },
  {
    title: 'Locke and Key',
    ...
    ISBN: '24124929',
    thumbnail:
      'https://i0.wp.com/www.tor.com/wp-content/uploads/2014/12/WTL02.jpg?resize=516%2C800&type=vertical',
    availability: true,
  },
  {
    title: 'Elon Musk',
    ...
    ISBN: '612496249',
    thumbnail:
      'https://m.media-amazon.com/images/I/61ndSI8HmtL._AC_UF1000,1000_QL80_.jpg',
    availability: true,
  },
  {
    title: 'Atomic Habits',
    ...
    ISBN: '21222022',
    thumbnail:
      'https://www.booksfree.org/wp-content/uploads/2021/09/24.jpg',
    availability: true,
  },
  {
  ...
  },
  {
    ...
    ISBN: '32353253',
    thumbnail:
      'https://cdn.shopify.com/s/files/1/0590/3830/2344/products/WebsiteNew_24.png?v=1661627991',
    availability: true,
  },
  {
    title: 'Naruto',
...
app.post('/api/books', (req, res) => {
    const { title, genre, author, ISBN, thumbnail, availability } = req.body;
